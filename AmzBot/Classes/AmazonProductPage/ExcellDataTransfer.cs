...
{
    public class ExcellDataTransfer
    {
        ...
        private static void ExcelIslemleri()
        {
            ...
            pck.Workbook.Properties.Title = "AMAZON ÜRÜN ARAMASI";//Başlık
            pck.Workbook.Properties.Author = "Özgür GÜRGEN";//Yazar
            pck.Workbook.Properties.Company = "OASIS GLOBAL";//Şirket
